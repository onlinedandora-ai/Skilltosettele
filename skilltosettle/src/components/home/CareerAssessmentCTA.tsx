...
export default function CareerAssessmentCTA() {
  ...
  const handleWhatsAppDirect = () => {
    const text = `Hi! I completed the Career Assessment form on SkilltoSettle.\nName: ${formData.name}\nGoal: ${formData.goal}\nDomain: ${formData.domain}\nPhone: ${formData.phone}\nCan you recommend the best learning path?`;
        ...
        <div className={styles.card}>
          <div className={styles.leftCol}>
            ...
            <p className={styles.desc}>
              Get a personalized, 1-on-1 skill analysis and curated learning roadmap from our senior mentors. No automated spam — just honest, practical career guidance.
            </p>

            <div className={styles.checklist}>
              <div className={styles.checkItem}>
                <span className={styles.checkIcon}>✓</span>
                <span>Evaluate your current background & target salary bracket</span>
              </div>
              <div className={styles.checkItem}>
                <span className={styles.checkIcon}>✓</span>
              ...
              <div className={styles.checkItem}>
                <span className={styles.checkIcon}>✓</span>
                <span>Discover which skills are commanding the highest demand</span>
              </div>
              <div className={styles.checkItem}>
                <span className={styles.checkIcon}>✓</span>
                <span><strong>Course Completion Certificate Included:</strong> Verifiable accredited credential upon track completion</span>
              </div>
            </div>

            <div className={styles.trustNote}>
              <span>Your contact details are 100% private. Zero spam policy.</span>
            </div>
          </div>
          ...
          <div className={styles.rightCol}>
            {submitted ? (
              <div className={styles.successBox}>
                <h3 className={styles.successTitle}>Assessment Details Received</h3>
              ...
              <form className={styles.form} onSubmit={handleSubmit}>
                <h3 className={styles.formTitle}>Request Free Recommendation</h3>
                ...
                <div className={styles.grid2}>
                  ...
                  <div className={styles.formGroup}>
                    <label className="label" htmlFor="whatsappNumber">WhatsApp Phone</label>
                    <input
                      id="whatsappNumber"
                      type="tel"
                      required
